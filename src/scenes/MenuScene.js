...
export default class MenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    const rules = [
      'Карен кидает поручения. Лови Серёгой и сгружай в департамент по ЦВЕТУ папки.',
      'В руках максимум 4. Верный лоток — очки и серия. Чужой — штраф и злость босса.',
      'Серое поручение со знаком «?» примет любой департамент, но без бонуса. Просрочка и падение — минус жизнь.',
    ];
